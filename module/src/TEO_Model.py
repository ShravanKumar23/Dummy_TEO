...
def buildmodel(sets_df, df, defaults_df, mcs_df, n):
    ...
    df["INDEX"] = [
        ...
        .replace("-nan", "")
        .replace("-<NA>", "")
        for r, rr, ld, e, f, lh, ls, l, s, m, t, y in zip(
            df.REGION,
            df.REGION2,
            df.DAYTYPE,
            df.EMISSION,
    ...
    while i <= n:
        ...
        logging.info(
            f"\t{dt.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\t" f"Model run: {i}"
        )
        ...
        variables = {
            ...
            # ====  Storage  ====
            "RateOfStorageCharge": {
                "sets": [REGION, STORAGE, TIMESLICE, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "s", "l", "y"],
            ...
            "NetChargeWithinYear": {
                "sets": [REGION, DAYTYPE, DAILYTIMEBRACKET, SEASON, STORAGE, YEAR],
                "lb": None,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "ld", "lh", "ls", "s", "y"],
            },
            "NetChargeWithinDay": {
                "sets": [REGION, DAYTYPE, DAILYTIMEBRACKET, SEASON, STORAGE, YEAR],
                "lb": None,
            ...
            "StorageLevelSeasonStart": {
                "sets": [REGION, SEASON, STORAGE, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "ls", "s", "y"],
            },
            "StorageLevelTimesliceStart": {
                "sets": [REGION, STORAGE, TIMESLICE, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
            ...
            "StorageLevelDayTypeStart": {
                "sets": [REGION, DAYTYPE, SEASON, STORAGE, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "ld", "ls", "s", "y"],
            ...
            "DiscountedCapitalInvestmentByStorage": {
                "sets": [REGION, STORAGE],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
            ...
            "DiscountedSalvageValueByStorage": {
                "sets": [REGION, STORAGE],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
            ...
            # ====  Activity Variables  ====
            "RateOfActivity": {
                "sets": [REGION, TIMESLICE, MODE_OF_OPERATION, TECHNOLOGY, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "l", "m", "t", "y"],
            ...
            "RateOfTotalActivity": {
                "sets": [REGION, TIMESLICE, TECHNOLOGY, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "l", "t", "y"],
            ...
            "TotalAnnualTechnologyActivityByMode": {
                "sets": [REGION, MODE_OF_OPERATION, TECHNOLOGY, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "m", "t", "y"],
            ...
            "RateOfProductionByTechnologyByMode": {
                "sets": [REGION, FUEL, TIMESLICE, MODE_OF_OPERATION, TECHNOLOGY, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "f", "l", "m", "t", "y"],
            ...
            "ProductionByTechnologyAnnual": {
                "sets": [REGION, FUEL, TECHNOLOGY, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "f", "t", "y"],
            ...
            "Trade": {
                "sets": [REGION, REGION2, FUEL, TIMESLICE, YEAR],
                "lb": None,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "rr", "f", "l", "y"],
            ...
            "DiscountedCapitalInvestmentByTechnology": {
                "sets": [REGION, TECHNOLOGY],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
            ...
            "DiscountedSalvageValueByTechnology": {
                "sets": [REGION, TECHNOLOGY],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
            ...
            "DiscountedOperatingCostByTechnology": {
                "sets": [REGION, TECHNOLOGY],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
            ...
            "TotalDiscountedFixedOperatingCost": {
                "sets": [REGION, TECHNOLOGY],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
            ...
            "AnnualTechnologyEmissionByMode": {
                "sets": [REGION, EMISSION, MODE_OF_OPERATION, TECHNOLOGY, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "e", "m", "t", "y"],
            ...
            "AnnualTechnologyEmission": {
                "sets": [REGION, EMISSION, TECHNOLOGY, YEAR],
                "lb": 0,
                "ub": None,
                "cat": "Continuous",
                "indices": ["r", "e", "t", "y"],
        ...
        DiscountedCapitalInvestmentByStorage = createVariable(
            "DiscountedCapitalInvestmentByStorage", variables
        )
        ...
        DiscountedSalvageValueByStorage = createVariable(
            "DiscountedSalvageValueByStorage", variables
        )
        ...
        DiscountedSalvageValueByTechnology = createVariable(
            "DiscountedSalvageValueByTechnology", variables
        )
        OperatingCost = createVariable("OperatingCost", variables)
        DiscountedCapitalInvestmentByTechnology = createVariable(
            "DiscountedCapitalInvestmentByTechnology", variables
        )
        DiscountedOperatingCost = createVariable("DiscountedOperatingCost", variables)
        DiscountedOperatingCostByTechnology = createVariable(
            "DiscountedOperatingCostByTechnology", variables
        )
        ...
        DiscountedAnnualFixedOperatingCost = createVariable(
            "DiscountedAnnualFixedOperatingCost", variables
        )
        TotalDiscountedFixedOperatingCost = createVariable(
            "TotalDiscountedFixedOperatingCost", variables
        )
        ...
        model += (
            Cost == pulp.lpSum([TotalDiscountedCost.get(ci(ry)) for ry in REGION_YEAR]),
            "Cost_function",
        )
        ...
        for rfly in REGION_FUEL_TIMESLICE_YEAR:
            # EQ_SpecifiedDemand
            model += (
                RateOfDemand.get(ci(rfly))
                == SpecifiedAnnualDemand.get(
                    ci([*rfly[0:2], rfly[3]]), dflt.get("SpecifiedAnnualDemand")
                )
                * SpecifiedDemandProfile.get(
                    ci(rfly), dflt.get("SpecifiedDemandProfile")
                )
        ...
        for rlty in REGION_TIMESLICE_TECHNOLOGY_YEAR:
            ...
            model += (
                RateOfTotalActivity.get(ci(rlty))
                == pulp.lpSum(
                    [
                        (
                            RateOfActivity.get(ci([*rlty[0:2], m, *rlty[2:4]]))
                            * OutputModeofoperation.get(
                                ci([rlty[0], m, *rlty[2:4]]),
                                dflt.get("OutputModeofoperation"),
                            )
                        )
            ...
            model += (
                RateOfTotalActivity.get(ci(rlty))
                <= TotalCapacityAnnual.get(ci([rlty[0], *rlty[2:4]]))
                * CapacityFactor.get(ci(rlty), dflt.get("CapacityFactor"))
                * CapacityToActivityUnit.get(
        ...
        for rty in REGION_TECHNOLOGY_YEAR:
            ...
            model += (
                AccumulatedNewCapacity.get(ci(rty))
                == pulp.lpSum(
                    [
                        NewCapacity.get(ci([*rty[0:2], yy]))
                        for yy in YEAR
                        if (
                            float(int(rty[2]) - int(yy))
                            < float(
                                OperationalLife.get(
                                    ci(rty[0:2]), dflt.get("OperationalLife")
                                )
                            )
                        )
                        and (int(rty[2]) - int(yy) >= 0)
                    ]
                ),
                "",
            )
            ...
            model += (
                TotalCapacityAnnual.get(ci(rty))
                == AccumulatedNewCapacity.get(ci(rty))
                + ResidualCapacity.get(ci(rty), dflt.get("ResidualCapacity")),
                "",
            )

            if (
                CapacityOfOneTechnologyUnit.get(
                    ci(rty), dflt.get("CapacityOfOneTechnologyUnit")
                )
                != 0
            ):
                # CAa5_TotalNewCapacity
                model += (
                    NewCapacity.get(ci(rty))
                    == CapacityOfOneTechnologyUnit.get(
                        ci(rty), dflt.get("CapacityOfOneTechnologyUnit")
                    )
            ...
            model += (
                ...
                * AvailabilityFactor.get(
                    ci([rlty[0], *rlty[2:4]]), dflt.get("AvailabilityFactor")
                )
                * CapacityToActivityUnit.get(
                    ci([rlty[0], rlty[2]]), dflt.get("CapacityToActivityUnit")
                ),
        ...
        for rflmty in REGION_FUEL_TIMESLICE_MODE_OF_OPERATION_TECHNOLOGY_YEAR:
            ...
            if (
                OutputActivityRatio.get(
                    ci([*rflmty[0:2], *rflmty[3:6]]), dflt.get("OutputActivityRatio")
                )
                != 0
            ):
                model += (
                    RateOfProductionByTechnologyByMode.get(ci(rflmty))
                    == RateOfActivity.get(ci([rflmty[0], *rflmty[2:6]]))
                    * OutputActivityRatio.get(
                        ci([*rflmty[0:2], *rflmty[3:6]]),
            ...
            if (
                InputActivityRatio.get(
                    ci([*rflmty[0:2], *rflmty[3:6]]), dflt.get("InputActivityRatio")
                )
                != 0
            ):
                model += (
                    RateOfUseByTechnologyByMode.get(ci(rflmty))
                    == RateOfActivity.get(ci([rflmty[0], *rflmty[2:6]]))
                    * (
                        1
                        / InputActivityRatio.get(
        ...
        for rflty in REGION_FUEL_TIMESLICE_TECHNOLOGY_YEAR:
            ...
            model += (
                RateOfProductionByTechnology.get(ci(rflty))
                == pulp.lpSum(
                    [
                        RateOfProductionByTechnologyByMode.get(
                            ci([*rflty[0:3], m, *rflty[3:5]])
                        )
                        for m in MODE_OF_OPERATION
                        if OutputActivityRatio.get(
                            ci([*rflty[0:2], m, *rflty[3:5]]),
                            dflt.get("OutputActivityRatio"),
                        )
                        != 0
                    ]
            ...
            model += (
                ...
                == pulp.lpSum(
                    [
                        RateOfUseByTechnologyByMode.get(
                            ci([*rflty[0:3], m, *rflty[3:5]])
                        )
                        for m in MODE_OF_OPERATION
                        if InputActivityRatio.get(
                            ci([*rflty[0:2], m, *rflty[3:5]]),
                            dflt.get("InputActivityRatio"),
                        )
                        != 0
        ...
        for rfly in REGION_FUEL_TIMESLICE_YEAR:
            ...
            model += (
                RateOfProduction.get(ci(rfly))
                == pulp.lpSum(
                    [
                        RateOfProductionByTechnology.get(ci([*rfly[0:3], t, rfly[3]]))
                        for t in TECHNOLOGY
                    ]
                ),
                "",
            ...
            model += (
                Production.get(ci(rfly))
                == RateOfProduction.get(ci(rfly)) * YearSplit.get(ci(rfly[2:4])),
                "",
            )
            ...
            model += (
                ...
                == pulp.lpSum(
                    [
                        RateOfUseByTechnology.get(ci([*rfly[0:3], t, rfly[3]]))
                        for t in TECHNOLOGY
                    ]
                )
                * YearSplit.get(ci(rfly[2:4])),
            ...
            model += (
                Demand.get(ci(rfly))
                == RateOfDemand.get(ci(rfly)) * YearSplit.get(ci(rfly[2:4])),
                "",
            )
            ...
            model += (
                ...
                + (
                    ...
                    * (8760 / int(max(TIMESLICE)))
                )
                + pulp.lpSum(
                    [
                        Trade.get(ci([rfly[0], rr, *rfly[1:4]]))
                        * TradeRoute.get(
                            ci([rfly[0], rr, rfly[1], rfly[3]]), dflt.get("TradeRoute")
                        )
                        for rr in REGION2
                    ]
                ),
        ...
        for rflty in REGION_FUEL_TIMESLICE_TECHNOLOGY_YEAR:
            ...
            model += (
                ProductionByTechnology.get(ci(rflty))
                == pulp.lpSum(
                    [
                        RateOfProductionByTechnologyByMode.get(
                            ci([*rflty[0:3], m, *rflty[3:5]])
        ...
        for rlty in REGION_TIMESLICE_TECHNOLOGY_YEAR:
            # Acc1_FuelProductionByTechnology
            model += (
                ProductionFromTechnology.get(ci(rlty))
                == pulp.lpSum(
                    [
                        ProductionByTechnology.get(ci([*rlty[0:1], f, *rlty[1:4]]))
                        for f in FUEL
                    ]
                ),
                "",
        ...
        for rmty in REGION_MODE_OF_OPERATION_TECHNOLOGY_YEAR:
            ...
            model += (
                TotalAnnualTechnologyActivityByMode.get(ci(rmty))
                == pulp.lpSum(
                    [
                        RateOfActivity.get(ci([rmty[0], l, *rmty[1:4]]))
                        * YearSplit.get(ci([l, rmty[3]]))
                        for l in TIMESLICE
                    ]
                ),
                "",
        ...
        for rsy in REGION_STORAGE_YEAR:
            if StorageL2D.get(ci(rsy[0:2]), dflt.get("StorageL2D")) == 0:
                model += (
                    StorageSurfaceArea.get(ci(rsy))
                    == 0.0744
                    * AccumulatedNewStorageCapacity.get(ci(rsy))
                    * Storagetagheating.get(ci(rsy[0:2]), dflt.get("Storagetagheating"))
                    + 0.0361
                    * AccumulatedNewStorageCapacity.get(ci(rsy))
                    * Storagetagcooling.get(
        ...
        for rsly in REGION_STORAGE_TIMESLICE_YEAR:
            ...
            model += (
                StorageLossesheating.get(ci(rsly))
                == (
                    StorageSurfaceArea.get(ci([*rsly[0:2], rsly[3]]))
                    * 0.0036
                    * (8760 / int(max(TIMESLICE)))
                    * (
                        StorageUvalue.get(
                            ci([*rsly[0:2], rsly[3]]), dflt.get("StorageUvalue")
                        )
                    )
                    * (
                        (
                            (
                                (
                                    StorageFlowTemperature.get(
                                        ci([*rsly[0:2], rsly[3]]),
                                        dflt.get("StorageFlowTemperature"),
                                    )
                                )
                                + (
                ...
                model += (
                    ...
                    + pulp.lpSum(
                        [
                            (
                                (
                                    RateOfStorageCharge.get(
                                        ci([*rsy[0:2], l, str(int(rsy[2]) - 1)])
                                    )
                                    - RateOfStorageDischarge.get(
                                        ci([*rsy[0:2], l, str(int(rsy[2]) - 1)])
                                    )
                                )
                                * YearSplit.get(ci([l, str(int(rsy[2]) - 1)]))
                            )
                            for l in TIMESLICE
                        ]
                    ),
        ...
        for rsly in REGION_STORAGE_TIMESLICE_YEAR:
            # S1_RateOfStorageCharge
            model += (
                RateOfStorageCharge.get(ci(rsly))
                == pulp.lpSum(
                    [
                        RateOfActivity.get(ci([rsly[0], rsly[2], *mt, rsly[3]]))
                        * TechnologyToStorage.get(
                            ci([*rsly[0:2], *mt]), dflt.get("TechnologyToStorage")
                        )
                        for mt in MODE_OF_OPERATION_TECHNOLOGY
            ...
            # S2_RateOfStorageDischarge
            model += (
                RateOfStorageDischarge.get(ci(rsly))
                == pulp.lpSum(
                    [
                        RateOfActivity.get(ci([rsly[0], rsly[2], *mt, rsly[3]]))
        ...
        for rsly in REGION_STORAGE_TIMESLICE_YEAR:
            ...
            if int(rsly[2]) == int(min(TIMESLICE)):
                ...
                model += (
                    StorageLevelTimesliceStart.get(ci(rsly))
                    == StorageLevelTimesliceStart.get(
                        ci([*rsly[0:2], str(int(rsly[2]) - 1), rsly[3]])
                    )
                    - StorageLosses.get(
                        ci([*rsly[0:2], str(int(rsly[2]) - 1), rsly[3]])
                    )
        ...
        for rs in REGION_STORAGE:
            ...
            model += (
                ...
                == pulp.lpSum(
                    [
                        RateOfActivity.get(ci([rs[0], *lmty]))
                        * TechnologyToStorage.get(
                            ci([*rs[0:2], *lmty[1:3]]), dflt.get("TechnologyToStorage")
                        )
                        * YearSplit.get(ci([lmty[0], lmty[3]]))
                        for lmty in TIMESLICE_MODE_OF_OPERATION_TECHNOLOGY_YEAR
                        if TechnologyToStorage.get(
                            ci(([*rs[0:2], *lmty[1:3]])),
                            dflt.get("TechnologyToStorage"),
                        )
        ...
        for rsy in REGION_STORAGE_YEAR:
            ...
            model += (
                ...
                == pulp.lpSum(
                    [
                        NewStorageCapacity.get(ci([*rsy[0:2], yy]))
                        for yy in YEAR
                        if (
                            float(int(rsy[2]) - int(yy))
                            < float(
                                OperationalLifeStorage.get(
                                    ci(rsy[0:2]), dflt.get("OperationalLifeStorage")
                                )
                            )
                        )
                        and (int(rsy[2]) - int(yy) >= 0)
                    ]
                ),
                "",
            )
            ...
            model += (
                StorageUpperLimit.get(ci(rsy))
                == (
                    AccumulatedNewStorageCapacity.get(ci(rsy))
                    + ResidualStorageCapacity.get(
                        ci(rsy), dflt.get("ResidualStorageCapacity")
                    )
                ),
                "",
            )
            ...
            model += (
                StorageUpperLimit.get(ci(rsy))
                <= StorageMaxCapacity.get(ci(rsy[0:2]), dflt.get("StorageMaxCapacity")),
                "",
            )
        ...
        for rsly in REGION_STORAGE_TIMESLICE_YEAR:
            ...
            model += (
                StorageLevelTimesliceStart.get(ci(rsly))
                >= MinStorageCharge.get(
                    ci([*rsly[0:2], rsly[3]]), dflt.get("MinStorageCharge")
                )
        ...
        for rsy in REGION_STORAGE_YEAR:
                ...
                * (
                    ...
                    / (
                        (
                            1
                            + DiscountRateSto.get(
                                ci(rsy[0:2]), dflt.get("DiscountRateSto")
                            )
                        )
            ...
            if (
                (DepreciationMethod.get(rsy[0], dflt.get("DepreciationMethod")) == 1)
                and (
                    float(
                        int(rsy[2])
                        + OperationalLifeStorage.get(
                ...
                (DepreciationMethod.get(rsy[0], dflt.get("DepreciationMethod")) == 2)
                and (
                    float(
                        int(rsy[2])
                        + OperationalLifeStorage.get(
                ...
                model += (
                    SalvageValueStorage.get(ci(rsy))
                    == CapitalInvestmentStorage.get(ci(rsy))
                    * (1 - (int(max(YEAR)) - int(rsy[2]) + 1))
                    / OperationalLifeStorage.get(
                        ci(rsy[0:2]), dflt.get("OperationalLifeStorage")
                    ),
                    "",
            ...
            if (
                ...
                and (DiscountRateSto.get(ci(rsy[0:2]), dflt.get("DiscountRateSto")) > 0)
            ):
                model += (
                    SalvageValueStorage.get(ci(rsy))
                    == CapitalInvestmentStorage.get(ci(rsy))
            ...
            model += (
                TotalDiscountedStorageCost.get(ci(rsy))
                == DiscountedCapitalInvestmentStorage.get(ci(rsy))
                - DiscountedSalvageValueStorage.get(ci(rsy)),
                "",
            )
        ...
        for rty in REGION_TECHNOLOGY_YEAR:
            ...
            model += (
                CapitalInvestment.get(ci(rty))
                == CapitalCost.get(ci(rty), dflt.get("CapitalCost"))
                * NewCapacity.get(ci(rty)),
                "",
            )
            # CC2_DiscountingCapitalInvestment
            model += (
                DiscountedCapitalInvestment.get(ci(rty))
                == CapitalInvestment.get(ci(rty))
                * (
                    1
                    / (
                        (
                            1
                            + DiscountRateTech.get(
                                ci(rty[0:2]), dflt.get("DiscountRateTech")
                            )
                        )
        ...
        for rs in REGION_STORAGE:
            ...
            model += (
                DiscountedSalvageValueByStorage.get(ci(rs))
                == pulp.lpSum(
                    [DiscountedSalvageValueStorage.get(ci([*rs, y])) for y in YEAR]
                ),
                "",
            )
            #         # SI5.1_DiscountingCapitalInvestmentbyStorageBusinessModule
            model += (
                DiscountedCapitalInvestmentByStorage.get(ci(rs))
                == pulp.lpSum(
                    [DiscountedCapitalInvestmentStorage.get(ci([*rs, y])) for y in YEAR]
                ),
                "",
            )
        ...
        for rty in REGION_TECHNOLOGY_YEAR:
            ...
            if (
                (DepreciationMethod.get(rty[0], dflt.get("DepreciationMethod")) == 1)
                and (
                    float(
                        int(rty[2])
                ...
                and (
                    DiscountRateTech.get(ci(rty[0:2]), dflt.get("DiscountRateTech")) > 0
                )
            ):
                model += (
                    SalvageValue.get(ci(rty))
                    == CapitalCost.get(ci(rty), dflt.get("CapitalCost"))
                    * NewCapacity.get(ci(rty))
                    * (
                        1
            ...
            if (
                ...
                and (
                    DiscountRateTech.get(ci(rty[0:2]), dflt.get("DiscountRateTech"))
                    == 0
                )
            ) or (
                (DepreciationMethod.get(rty[0], dflt.get("DepreciationMethod")) == 2)
                and (
                    float(
                        int(rty[2])
                        + OperationalLife.get(ci(rty[0:2]), dflt.get("OperationalLife"))
            ...
            model += (
                ...
                == pulp.lpSum(
                    [
                        TotalAnnualTechnologyActivityByMode.get(
                            ci([rty[0], m, *rty[1:3]])
                        )
                        * VariableCost.get(
                            ci([rty[0], m, *rty[1:3]]), dflt.get("VariableCost")
                        )
                        for m in MODE_OF_OPERATION
                    ]
                ),
            ...
            model += (
                AnnualFixedOperatingCost.get(ci(rty))
                == TotalCapacityAnnual.get(ci(rty))
                * FixedCost.get(ci(rty), dflt.get("FixedCost")),
                "",
            )
            model += (
                DiscountedAnnualFixedOperatingCost.get(ci(rty))
                == AnnualFixedOperatingCost.get(ci(rty))
                * (
                    1
                    / (
            ...
            model += (
                DiscountedOperatingCost.get(ci(rty))
                == OperatingCost.get(ci(rty))
                * (
                    1
                    / (
        ...
        for rmty in REGION_MODE_OF_OPERATION_TECHNOLOGY_YEAR:
            model += (
                VariableOMCost.get(ci(rmty))
                == 1 * VariableCost.get(ci(rmty), dflt.get("VariableCost")),
                "",
            )
        ...
        for rt in REGION_TECHNOLOGY:
            ...
            model += (
                DiscountedCapitalInvestmentByTechnology.get(ci(rt))
                == pulp.lpSum(
                    [DiscountedCapitalInvestment.get(ci([*rt, y])) for y in YEAR]
                ),
                "",
            )
            #         # OC4.1_DiscountedOperatingCostsbytechnologyBusinessModule
            model += (
                DiscountedOperatingCostByTechnology.get(ci(rt))
                == pulp.lpSum(
                    [DiscountedOperatingCost.get(ci([*rt, y])) for y in YEAR]
                ),
                "",
            )
            #         # SV4.1_DiscountedSalvageValuebytechnologyBusinessModule
            model += (
                DiscountedSalvageValueByTechnology.get(ci(rt))
                == pulp.lpSum([DiscountedSalvageValue.get(ci([*rt, y])) for y in YEAR]),
                "",
            )
            # SV4.TotalDiscountedFixedOperatingCostBusinessModule
            model += (
                TotalDiscountedFixedOperatingCost.get(ci(rt))
                == pulp.lpSum(
                    [DiscountedAnnualFixedOperatingCost.get(ci([*rt, y])) for y in YEAR]
                ),
                "",
            )
        ...
        for ry in REGION_YEAR:
            ...
            model += (
                TotalDiscountedCost.get(ci(ry))
                == pulp.lpSum(
                    [
                        TotalDiscountedCostByTechnology.get(ci([ry[0], t, ry[1]]))
                        for t in TECHNOLOGY
                    ]
                )
                + pulp.lpSum(
                    [
                        TotalDiscountedStorageCost.get(ci([ry[0], s, ry[1]]))
                        for s in STORAGE
                    ]
                ),
                "",
        ...
        for rty in REGION_TECHNOLOGY_YEAR:
            ...
            model += (
                TotalDiscountedCostByTechnology.get(ci(rty))
                == DiscountedOperatingCost.get(ci(rty))
                + DiscountedCapitalInvestment.get(ci(rty))
            ...
            if (
                TotalAnnualMinCapacity.get(ci(rty), dflt.get("TotalAnnualMinCapacity"))
                > 0
            ):
                model += (
                    TotalCapacityAnnual.get(ci(rty))
                    >= TotalAnnualMinCapacity.get(
                        ci(rty), dflt.get("TotalAnnualMaxCapacity")
                    ),
                    "",
                )
            ...
            model += (
                NewCapacity.get(ci(rty))
                <= TotalAnnualMaxCapacityInvestment.get(
            ...
            if (
                TotalAnnualMinCapacityInvestment.get(
            ...
            model += (
                TotalTechnologyAnnualActivity.get(ci(rty))
                == pulp.lpSum(
                    [
                        RateOfTotalActivity.get(ci([rty[0], l, *rty[1:3]]))
                        * YearSplit.get(ci([l, rty[2]]))
                        for l in TIMESLICE
                    ]
                ),
                "",
            ...
            model += (
                TotalTechnologyAnnualActivity.get(ci(rty))
                <= TotalTechnologyAnnualActivityUpperLimit.get(
            ...
            if (
                TotalTechnologyAnnualActivityLowerLimit.get(
        ...
        for rt in REGION_TECHNOLOGY:
            ...
            model += (
                TotalTechnologyModelPeriodActivity.get(ci(rt))
                == pulp.lpSum(
            ...
            if (
                TotalTechnologyModelPeriodActivityUpperLimit.get(
            ...
            if (
                TotalTechnologyModelPeriodActivityLowerLimit.get(
        ...
        for ry in REGION_YEAR:
            ...
            model += (
                TotalCapacityInReserveMargin.get(ci(ry))
                == pulp.lpSum(
                    [
                        TotalCapacityAnnual.get(ci([ry[0], t, ry[1]]))
                        * ReserveMarginTagTechnology.get(
                            ci([ry[0], t, ry[1]]),
                            dflt.get("ReserveMarginTagTechnology"),
                        )
                        * CapacityToActivityUnit.get(
                            ci([ry[0], t]), dflt.get("CapacityToActivityUnit")
                        )
                        for t in TECHNOLOGY
                    ]
                ),
        ...
        for rly in REGION_TIMESLICE_YEAR:
            ...
            model += (
                DemandNeedingReserveMargin.get(ci(rly))
                == pulp.lpSum(
                    [
                        RateOfProduction.get(ci([rly[0], f, *rly[1:3]]))
                        * ReserveMarginTagFuel.get(
                            ci([rly[0], f, rly[2]]), dflt.get("ReserveMarginTagFuel")
                        )
                        for f in FUEL
                    ]
                ),
            ...
            model += (
                DemandNeedingReserveMargin.get(ci(rly))
                <= TotalCapacityInReserveMargin.get(ci([rly[0], rly[2]]))
                * (
                    1
                    / ReserveMargin.get(ci([rly[0], rly[2]]), dflt.get("ReserveMargin"))
                ),
                "",
            )
        ...
        for rfty in REGION_FUEL_TECHNOLOGY_YEAR:
            ...
            model += (
                ProductionByTechnologyAnnual.get(ci(rfty))
                == pulp.lpSum(
                    [
                        ProductionByTechnology.get(ci([rfty[0], l, *rfty[1:4]]))
                        for l in TIMESLICE
                    ]
                ),
                "",
        ...
        for ry in REGION_YEAR:
            ...
            # RE3_FuelIncluded
            model += (
                RETotalProductionOfTargetFuelAnnual.get(ci(ry))
                == pulp.lpSum(
                    [
                        RateOfProduction.get(ci([ry[0], *fl, ry[1]]))
                        * YearSplit.get(ci([fl[1], ry[1]]))
                        * RETagFuel.get(
                            ci([ry[0], fl[0], ry[1]]), dflt.get("RETagFuel")
                        )
                        for fl in FUEL_TIMESLICE
                    ]
                ),
                "",
            )
            ...
            model += (
                pulp.lpSum(
                    [
                        ProductionByTechnologyAnnual.get(ci([ry[0], *ft, ry[1]]))
                        * RETagTechnology.get(
                            ci([ry[0], ft[1], ry[1]]), dflt.get("RETagTechnology")
                        )
                        for ft in FUEL_TECHNOLOGY
                    ]
                )
        ...
        for remty in REGION_EMISSION_MODE_OF_OPERATION_TECHNOLOGY_YEAR:
            ...
            model += (
                AnnualTechnologyEmissionByMode.get(ci(remty))
                == EmissionActivityRatio.get(
                    ci(remty), dflt.get("EmissionActivityRatio")
                )
        ...
        for rety in REGION_EMISSION_TECHNOLOGY_YEAR:
            ...
            model += (
                AnnualTechnologyEmission.get(ci(rety))
                == pulp.lpSum(
                    [
                        AnnualTechnologyEmissionByMode.get(
                            ci([*rety[0:2], m, *rety[2:4]])
                        )
                        for m in MODE_OF_OPERATION
                    ]
                ),
            ...
            model += (
                AnnualTechnologyEmissionPenaltyByEmission.get(ci(rety))
                == AnnualTechnologyEmission.get(ci(rety))
                * EmissionsPenalty.get(
        ...
        for rty in REGION_TECHNOLOGY_YEAR:
            ...
            model += (
                AnnualTechnologyEmissionsPenalty.get(ci(rty))
                == pulp.lpSum(
                    [
                        AnnualTechnologyEmissionPenaltyByEmission.get(
                            ci([rty[0], e, *rty[1:3]])
                        )
                        for e in EMISSION
                    ]
        ...
        for rey in REGION_EMISSION_YEAR:
            ...
            model += (
                AnnualEmissions.get(ci(rey))
                == pulp.lpSum(
                    [
                        AnnualTechnologyEmission.get(ci([*rey[0:2], t, rey[2]]))
                        for t in TECHNOLOGY
                    ]
                ),
                "",
            ...
            model += (
                AnnualEmissions.get(ci(rey))
                <= AnnualEmissionLimit.get(ci(rey), dflt.get("AnnualEmissionLimit"))
                - AnnualExogenousEmission.get(
                    ci(rey), dflt.get("AnnualExogenousEmission")
                ),
                "",
            )
        ...
        for re in REGION_EMISSION:
            ...
            model += (
                pulp.lpSum([AnnualEmissions.get(ci([*re, y])) for y in YEAR])
                == ModelPeriodEmissions.get(ci(re))
                - ModelPeriodExogenousEmission.get(
                    ci(re), dflt.get("ModelPeriodExogenousEmission")
                ),
                "",
            )
        ...
        logging.info(
            f"\t{dt.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\t" f"Model is built."
        )
